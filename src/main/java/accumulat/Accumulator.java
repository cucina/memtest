...
/**
 * <p>
 * Accumulates one or more variables together and maintains a running
 * {@code int} sum of the elements. Updates to this total sum are done via the
 * {@link #accumulate} method. The current value of the running total is
 * returned by calling {@link #getTotal}.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * The total sum can be set to 0 by calling {@link #reset}.
 * </p>
 *
 * <p>
 * Usage example:
 ...
 * </pre>
 * 
 * In this case, the value of {@code firstSum} is 6, {@code secondSum} is 4 and
 * the value of {@code total} is 10. Calling {@code accumulator.reset()} would
 * reset the total value to 0.
 * </p>
 */
